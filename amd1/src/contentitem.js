 ...
 *
 * See template: qtype_lti/contentitem
 *
    ...
    function($, notification, str, templates, FormField, ModalFactory, ModalEvents) {
        ...
        var contentItem = {
            ...
            init: function(url, postData) {
                ...
                var bodyPromise = templates.render('qtype_lti/contentitem', context);
        ...
        /**
         * Window function that can be called from qtype_lti/contentitem_return to close the dialogue and process the return data.
         *
