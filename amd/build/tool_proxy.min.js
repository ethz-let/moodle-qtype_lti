...
define(['core/ajax', 'core/notification'], function(ajax, notification) {
    return /** @alias module:qtype_lti/tool_proxy */ {
        /**
        ...
        query: function(args) {
            var request = {
                methodname: 'qtype_lti_get_tool_proxies',
                args: args || {}
            };
        ...
        'delete': function(id) {
            var request = {
                methodname: 'qtype_lti_delete_tool_proxy',
                args: {
                    id: id
                }
            };
        ...
        create: function(args) {
            var request = {
                methodname: 'qtype_lti_create_tool_proxy',
                args: args
            };
