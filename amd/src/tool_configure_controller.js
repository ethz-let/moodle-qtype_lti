 ...
 * @since 3.5
 */
define(['jquery', 'core/ajax', 'core/notification', 'core/templates', 'qtype_lti/events', 'qtype_lti/keys', 'qtype_lti/tool_type',
        ...
        function($, ajax, notification, templates, ltiEvents, KEYS, toolType, toolProxy, str) {
            ...
            var reloadToolList = function() {
                ...
                $.when(
                    ...
                    .done(function(types, proxies) {
                            templates.render('qtype_lti/tool_list', {tools: types, proxies: proxies})
            ...
            var addTool = function() {
                ...
                promise.fail(function() {
                    str.get_string('errorbadurl', 'qtype_lti')
                        .done(function(s) {
