 ...
 * @since      3.1
 */
define(['jquery', 'core/ajax', 'core/notification', 'qtype_lti/tool_type', 'qtype_lti/events', 'qtype_lti/keys', 'core/str'],
    ...
    var submitCartridgeURL = function() {
        ...
        promise.done(function() {
            ...
            str.get_string('failedtocreatetooltype', 'qtype_lti').done(function(s) {
                $(document).trigger(ltiEvents.NEW_TOOL_TYPE);
                $(document).trigger(ltiEvents.STOP_CARTRIDGE_REGISTRATION);
                $(document).trigger(ltiEvents.REGISTRATION_FEEDBACK, {
                    message: s,
