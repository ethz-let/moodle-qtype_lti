...
/**
 * Encapsules the behavior for creating a tool type from a cartridge URL in
 * Moodle. Manages the UI while operations are occuring.
 *
 * See template: qtype_lti/cartridge_registration_form
 *
 * @module qtype_lti/cartridge_registration_form
...
define(
        ...
        function ($, ajax, notification, toolType, ltiEvents, KEYS, str) {
            ...
            /**
             * Create a tool type from the cartridge URL that the user input.
             * This will send an ajax request to the Moodle server to create the
             * Type. The request will include the consumer key and secret, if
             * any.
             *
             * On success the page will be re-rendered to take the user back to
             * the original page with the list of tools and an alert notifying
             * them of success.
             *
