...
define(['core/ajax', 'core/notification'], function(ajax, notification) {
    return /** @alias module:qtype_lti/tool_type */ {
        /**
        ...
        query: function(args) {
            var request = {
                methodname: 'qtype_lti_get_tool_types',
                args: args || {}
            };
        ...
        create: function(args) {
            var request = {
                methodname: 'qtype_lti_create_tool_type',
                args: args
            };
        ...
        update: function(args) {
            var request = {
                methodname: 'qtype_lti_update_tool_type',
                args: args
            };
        ...
        'delete': function(id) {
            var request = {
                methodname: 'qtype_lti_delete_tool_type',
                args: {
                    id: id
                }
            };
        ...
        isCartridge: function(url) {
            var request = {
                methodname: 'qtype_lti_is_cartridge',
                args: {
                    url: url
                }
            };
