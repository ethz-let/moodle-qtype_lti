...
use qtype_lti\event\unknown_service_api_called;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_lti_event_unknown_service_api_called_test extends advanced_testcase {
    /*
     * Ensure create event works.
     */
    public function test_create_event() {
        $event = unknown_service_api_called::create();
        $this->assertInstanceOf('\qtype_lti\event\unknown_service_api_called', $event);
    }
