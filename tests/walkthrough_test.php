...
class qtype_lti_walkthrough_testcase extends qbehaviour_walkthrough_test_base {
    ...
    public function test_deferred_feedback_html_editor() {
        ...
        $q = test_question_maker::make_question('lti', 'editor');
    ...
    public function test_responsetemplate() {
        ...
        // Create an lti question.
        $q = test_question_maker::make_question('lti', 'responsetemplate');
        $this->start_attempt_at_question($q, 'deferredfeedback', 1);
    ...
    public function test_deferred_feedback_html_editor_with_files_attempt_on_last() {
        ...
        $question = $generator->create_question('lti', 'editorfilepicker', array('category' => $cat->id));
