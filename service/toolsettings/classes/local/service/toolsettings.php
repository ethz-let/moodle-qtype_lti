 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class toolsettings extends \qtype_lti\local\ltiservice\service_base {
     ...
     * @param \qtype_lti\local\ltiservice\resource_base $resource       Resource handling the request
     *
     * @return string
     */
