...
Feature: Configure tool types
  ...
  Scenario: Add a tool type from a cartridge URL
    When I set the field "url" to local url "/question/type/lti/tests/fixtures/ims_cartridge_basic_lti_link.xml"
    And I press "Add"
  ...
  Scenario: Try to add a non-existant cartridge
    When I set the field "url" to local url "/question/type/lti/tests/fixtures/nonexistant.xml"
    And I press "Add"
    Then I should see "Enter your consumer key and shared secret"
    And I press "Save changes"
  ...
  Scenario: Attempt to add a tool type from a configuration URL, then cancel
    When I set the field "url" to local url "/question/type/lti/tests/fixtures/tool_provider.php"
    And I press "Add"
