@qtype @qtype_lti
Feature: Preview a LTI question
  As a teacher
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | lti | Multi-choice-001 | two_of_four |
      | Test questions   | lti | Multi-choice-002 | one_of_four |
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I navigate to "Question bank" node in "Course administration"

  @javascript @_switch_window
  Scenario: Preview a LTI question and submit a partially correct response.
  ...
  @javascript @_switch_window
  Scenario: Preview a LTI question and submit a correct response.
    When I click on "Preview" "link" in the "Multi-choice-001" "table_row"
    And I switch to "questionpreview" window
    And I set the field "How questions behave" to "Immediate feedback"
    And I press "Start again with these options"
