@qtype @qtype_lti
Feature: Add LTI Qtype
  In order to provide LTI Qtype for learners
  As a teacher
  I need to be able to add LTI qtype to a course
  ...
  Background:
    ...
    And I navigate to "Manage tools" node in "Site administration > Plugins > Question Types > LTI (ETH)"
