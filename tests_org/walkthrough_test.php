...
/**
 * Overall tests of lti questions.
 *
 * @package        qtype
 * @subpackage     lti
...
require_once($CFG->dirroot . '/question/type/lti/tests/helper.php');
 ...
 * @license        http://www.lti.org/license
 */
class qtype_lti_walkthrough_test extends qbehaviour_walkthrough_test_base {
    public function test_interactive_point() {
        $q = test_question_maker::make_question('lti', 'point');
    ...
    public function test_interactive_manually() {
        $q = test_question_maker::make_question('lti', 'manually');
