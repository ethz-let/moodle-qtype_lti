...
/**
 * The qtype_lti unknown service api called event.
 *
 * @package    qtype_lti
...
/**
 * The qtype_lti unknown service api called event class.
 *
...
class unknown_service_api_called extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('ltiunknownserviceapicall', 'qtype_lti');
    }
