...
if (!empty($id)) {
    ...
    if (!empty($type->toolproxyid)) {
        ...
        $redirect = new moodle_url('/question/type/lti/toolssettings.php', $params);
        redirect($redirect);
    }
} else {
    $type = new stdClass();
...
$pageurl = new moodle_url('/question/type/lti/typessettings.php');
if (!empty($id)) {
    $pageurl->param('id', $id);
}
if (!empty($returnto)) {
...
$form = new qtype_lti_edit_types_form($pageurl, (object)array('isadmin' => true, 'istool' => false));
